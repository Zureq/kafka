package com.zureq.kafkatest.config;
...
public class TwitterConfig {
    ...
    @Bean
    public String twitterKafkaTopic() {
        return twitterKafkaTopic;
    }
    ...
    private List<Location> parseLocations(String[] locations) {
        ...
        for (int i = 0; i < locations.length / 4; i++) {
            result.add(new Location(
                            new Location.Coordinate(Double.parseDouble(locations[i * 2]), Double.parseDouble(locations[i * 2 + 1])),
